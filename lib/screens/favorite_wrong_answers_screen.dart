...
class FavoriteWrongAnswersScreen extends StatefulWidget {
  final FavoriteTest test;
  final Map<int, String> userAnswers;

  const FavoriteWrongAnswersScreen({
    super.key,
    required this.test,
  ...
  @override
  State<FavoriteWrongAnswersScreen> createState() => _FavoriteWrongAnswersScreenState();
}

class _FavoriteWrongAnswersScreenState extends State<FavoriteWrongAnswersScreen> {
  int _currentIndex = 0;
